...
\section{Selected Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {Deterministic Simulation Testing in Key-Value Databases}
          {Feb. 2025 -- Apr. 2025}
          {https://github.com/JamesChenSH/frost} % GitHub link
          {Zig} % Tech stack
          \resumeItemListStart
            \resumeItem{Implemented a simplified deterministic simulator for testing RocksDB, inspired by work done on TigerBeetleDB and Antithesis.}
            \resumeItem{Developed a modular interface that can be expanded to evaluate different key-value stores such as Valkey, FoundationDB and Cassandra.}
          \resumeItemListEnd
